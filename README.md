...
![highgui](https://github.com/lprsoft/lpreditor/blob/master/image2.jpg =100x20). It is also possible to see bounding boxes of caracters :![bbs](https://github.com/lprsoft/lpreditor/blob/master/image.jpg =250x) (activate show_boxes function in the code).
